...
incred_plot <- function(Inc, Prev, IncRedRange=c(0.25,0.75), steps = 25, Power = 0.8, alpha = 0.05, MDRI, RSE_MDRI, FRR, RSE_FRR, CR = 1, DE_H = 1, DE_R = 1, DE_C = 1, 
  ...
  IncReds <- IncReds*100
  plot <- ggplot2::qplot(IncReds, Ns, geom = "line", xlab = "Incidence Reduction (%)", ylab = "Required N")
  return(plot)
}