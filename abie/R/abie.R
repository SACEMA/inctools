...
#' abie has functions \emph{frr_binomial} to estimate false recency rate; \emph{mdri_ml_binomial} to estimate mean duration or recent infection; \emph{recencyI} to calculate estimates and confidence intervals for incidence and incidence difference, as well as other summary and inferenctial statistics related to the survey; \emph{SSPower} to calculate sample size needed for a given power in a test of incidence difference, or vice versa; and \emph{SSCprecision}, which gives sample size needed for a given precision in the incidence estimate.
#'
#' @docType package
#' @name abie
NULL
