...
recencyI <- function(PrevH, RSE_PrevH, PrevR, RSE_PrevR, Boot = FALSE, BS_Count = 10000, alpha = 0.05, BMest = "same.test",
  ...
  # here I depending on whethere Boot=T or not, I make the variance components their values under the variance scheme, or
  ...
  if (Boot == TRUE) {
    ...
    # 2&1, and 2&2.
    RSE_I.infSS <- sqrt(DM_Var_I.infSS)/I_Est  #ONLY EXECUTED IF Boot=F
  ...
  # Below gives p-value of tests of differences, and if Boot=F, p-values of test of differences when SS=infinity gives 4
