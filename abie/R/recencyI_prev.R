...
#' @details Function parameters must be specified to include assay test characteristics and survey results. Confidence intervals are computed via Delta method approximation, except when BOOT=TRUE is specified, in which case confidence intervals are generated by empirical bootstrap resampling. Input must be in appropriate ranges for appropriate untis. Some input values will make calculation impossible, and will be flagged with error notices.
#'
#' @examples
