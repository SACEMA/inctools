...
# This file contains random function calls for testing purposes.
...
incprecision(I = 0.015, RSE_I = 0.25, PrevH = 0.2, CR = 1, MDRI = 200, RSE_MDRI = 0.05,
...
incprecision(I = c(0.015, 0.02), RSE_I = 0.25, PrevH = 0.2, CR = 1, MDRI = 200, RSE_MDRI = 0.05,
    FRR = 0.01, RSE_FRR = 0.2, BigT = c(530, 730), DE_H = 1, DE_R = 1, n = "out",
    step = 5)
...
# the package will not build with error messages present incprecision ( I =0.015,
...
incprecision(I = 0.015, RSE_I = "out", PrevH = 0.2, CR = 0.7, MDRI = 200, RSE_MDRI = 0.05,
...
#####################################################################################################################
incprecision(I = 0.015, RSE_I = "out", PrevH = c(0.2, 0.22), CR = 1, MDRI = 200, RSE_MDRI = 0.05,
