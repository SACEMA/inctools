...
# example to get function working: probs<-prevcounts (N=c(5000,5000), N_H=c(1000,1000), N_testR=c(1000,1000),
...
# alpha=0.05 incprops(PrevH=probs[,1], RSE_PrevH=probs[,3], PrevR=probs[,2], RSE_PrevR=probs[,4], Boot = FALSE, BS_Count
...
incprops <- function(PrevH, RSE_PrevH, PrevR, RSE_PrevR, Boot = FALSE, BS_Count = 10000, alpha = 0.05, BMest = "same.test",
...
#'
#' @export
inccounts <- function(N, N_H, N_testR, N_R, DE_H = 1, DE_R = 1, BS_Count = 10000, Boot = FALSE, alpha = 0.05, BMest = "same.test",
                        MDRI, RSE_MDRI, FRR, RSE_FRR, BigT = 730, Covar_HR = 0) {
  ...
  counts.to.prev <- prevcounts(N = N, N_H = N_H, N_testR = N_testR, N_R = N_R, DE_H = DE_H, DE_R = DE_R)

  incprops(BS_Count = BS_Count, Boot = Boot, alpha = alpha, BMest = BMest, PrevH = counts.to.prev$PrevH, RSE_PrevH = counts.to.prev$RSE_PrevH,
...
#           PrevR = probs[,2], RSE_PrevR = probs[, 4], MDRI = c(200,210), RSE_MDRI = c(0.05,0.07), FRR = c(0.01,0.02), RSE_FRR = 0.2, BigT = 730)
# #
# # # (single survey)
