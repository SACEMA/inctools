...
## ---- echo=TRUE----------------------------------------------------------
ssprecision(I = 0.017, RSE_I = 'out', PrevH = c(0.10,0.20), CR = 1, MDRI = 211, RSE_MDRI = 0.05, 
