...
Incidence estimates from cross-sectional surveys using biomarkers for 'recent infection' require that the test for recent infection (usually an adapted diagnostic assay) be accurately characterised. The two critical parameters of test performance are the Mean Duration of Recent Infection (MDRI), denoted $\Omega_T$, (with $T$ the recency cutoff time), and False Recent Rate (FRR), denoted $\beta_T$. The explicit time cutoff $T$ was introduced by Kassanjee et al. $Epidemiology$, 2012.[^1] to differentiate between 'true recent' and 'false recent' results. They state:
