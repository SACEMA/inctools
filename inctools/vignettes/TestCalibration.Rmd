...
*Note: To keep compute time reasonable during execution of the example code, only 500 bootstraps are performed. To obtain reasonable standard errors and confidence intervals, 10,000 bootstraps are recommended.*
...
As above, but asking for both functional forms and parellelising the bootstrapping. In this case, the job is split over the number of logical cores the machine has available.
